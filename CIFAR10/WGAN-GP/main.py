...
print(len(cifar))
optim.Adam
loader = torch.utils.data.DataLoader(cifar,batch_size=64,shuffle=False,num_workers=1)
...
wgan = WassersteinGAN(device,loader,generator,discriminator,optimG,optimD,10.0,5,64,64,200000,1000,'./WGAN-GP.model')
#gan.load_model()
wgan.train()

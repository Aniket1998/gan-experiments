...
mnist = torchvision.datasets.MNIST('./MNIST',transform=transforms.Compose([transforms.Scale(64),transforms.ToTensor(),transforms.Normalize((.5,.5,.5),(.5,.5,.5))]),download=True)

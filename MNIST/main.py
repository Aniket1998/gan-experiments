...
gan = NonsaturatingGAN(device,loader,generator,discriminator,optimG,optimD,batch_size=32,sample_size=32,epochs=100,label_smooth=0.7,checkpoints='./nonsaturating-gan.model',recon='./images/')
gan.set_targets(1)
gan.load_model()
gan.train()
